...
"""
Neural Networks model : ensemble with Hierarchical C-SLTM and C-LSTM
"""
...
class HCL_CLSTM(nn.Module):
    
    def __init__(self, args):
        super(HCL_CLSTM, self).__init__()
        
        self.wordCLSTM = wordCLSTM(args)
        self.senCLSTM = sentCLSTM(args)
        self.CLSTM = CLSTM(args)
    ...
    def forward(self, embed, source,max_sents):
        ...
        logits_CLSTM = self.CLSTM(source)
        logits = logits_HCL + logits_CLSTM
